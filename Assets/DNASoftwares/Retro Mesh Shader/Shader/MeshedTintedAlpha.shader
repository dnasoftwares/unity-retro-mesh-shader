...
/*SF_DATA;ver:0.36;sub:START;pass:START;ps:flbk:Unlit/Transparent Colored,lico:1,lgpr:1,nrmq:1,limd:0,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:1,bsrc:3,bdst:7,culm:2,dpts:2,wrdp:False,ufog:True,aust:False,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32512,y:33027|diff-2-RGB,emission-48-OUT,alpha-16-OUT;n:type:ShaderForge.SFN_Color,id:2,x:32939,y:33047,ptlb:Tint Color,ptin:_TintColor,glob:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Tex2d,id:3,x:32939,y:32877,ptlb:Base Texture,ptin:_BaseTexture,ntxv:0,isnm:False|UVIN-4-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:4,x:33686,y:32874,uv:0;n:type:ShaderForge.SFN_ScreenParameters,id:6,x:33739,y:33110;n:type:ShaderForge.SFN_ScreenPos,id:7,x:33720,y:33279,sctp:2;n:type:ShaderForge.SFN_Multiply,id:16,x:32763,y:33192|A-3-A,B-2-A,C-47-A,D-43-OUT;n:type:ShaderForge.SFN_Code,id:43,x:33035,y:33224,code:,output:0,fname:ScreenToMesh,width:446,height:244,input:1,input:0,input:0,input:0,input_1_label:s,input_2_label:pxw,input_3_label:pxh,input_4_label:msz|A-7-UVOUT,B-6-PXW,C-6-PXH,D-46-OUT;n:type:ShaderForge.SFN_ValueProperty,id:46,x:33830,y:33411,ptlb:Mesh Size,ptin:_MeshSize,glob:False,v1:4;n:type:ShaderForge.SFN_VertexColor,id:47,x:33172,y:33012;n:type:ShaderForge.SFN_Multiply,id:48,x:32763,y:33073|A-2-RGB,B-47-RGB;proporder:2-3-46;pass:END;sub:END;*/

Shader "DNA Softwares/MeshedTintedAlpha" {
    Properties {
...
////// Emissive:
                ...
                float3 emissive = (_TintColor.rgb*node_47.rgb);
                float3 finalColor = emissive;
                float2 node_4 = i.uv0;
                float4 node_6 = _ScreenParams;
/// Final Color:
                return fixed4(finalColor,(tex2D(_BaseTexture,TRANSFORM_TEX(node_4.rg, _BaseTexture)).a*_TintColor.a*node_47.a*ScreenToMesh( sceneUVs.rg , node_6.r , node_6.g , _MeshSize )));
            }
            ENDCG
        }
    }
